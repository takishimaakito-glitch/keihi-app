...
import { Home, List, Tag, Settings, Plus, FileText, Camera, Pen, BarChart3, Star } from 'lucide-react';
    ...
    return (
        <Router>
            <div className="min-h-screen bg-[#F7F4F0] font-sans text-[#3D2B1F] flex flex-col pb-24 relative overflow-x-hidden">
                ...
                {/* --- 3. ボトムナビゲーション（固定） --- */}
                <nav className="fixed bottom-0 inset-x-0 h-24 bg-white/90 backdrop-blur-md border-t border-[#3D2B1F]/5 px-2 flex justify-center gap-3 sm:gap-8 md:gap-12 items-center z-50 shadow-[0_-10px_40px_rgba(61,43,31,0.05)] pb-2 w-full">
