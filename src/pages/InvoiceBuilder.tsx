...
const InvoiceBuilder = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F7F4F0] font-sans text-[#3D2B1F] pb-24 lg:pb-12 print:bg-white relative">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white px-4 py-3 rounded-xl border border-[#3D2B1F]/10 outline-none font-bold text-sm shadow-sm focus:ring-2 focus:ring-[#3D2B1F]/20 transition-all"
                                />
                            </div>
                            <div className="space-y-1">
            ...
            {(showPreview) && (
                <div className="fixed inset-0 z-50 flex items-center justify-center print:static print:block print:bg-white print:z-auto">
                    ...
                    {/* Modal Content */}
                    <div className="relative z-10 w-full h-full sm:w-auto sm:h-auto sm:max-h-[95vh] flex flex-col items-center">
                        ...
                        <div className="w-full max-w-[210mm] flex justify-between items-center p-4 print:hidden shrink-0">
                            ...
                            <div className="flex gap-3">
                                <button onClick={() => alert('ブラウザの印刷設定から「PDFとして保存」を選択し、「背景のグラフィック」をオンにして保存してください。')} className="bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-full font-bold text-xs flex items-center transition-colors">
                                    <Download size={16} className="mr-2" /> 保存 (PDF)
                                </button>
                                <button onClick={handlePrint} className="bg-white text-[#3D2B1F] px-4 py-2 rounded-full font-black text-xs flex items-center shadow-lg hover:scale-105 active:scale-95 transition-transform">
                                    <Printer size={16} className="mr-2 opacity-50" /> 印刷する
                                </button>
                            </div>
                        </div>

                        {/* Paper Output Container */}
                        <div className="flex-1 overflow-y-auto sm:rounded-[32px] w-full flex justify-center custom-scrollbar print:overflow-visible print:rounded-none">
                            <div className="relative transform origin-top w-[210mm] scale-[0.6] sm:scale-75 md:scale-90 lg:scale-100 print:scale-100 print:absolute print:top-0 print:left-0 print:m-0" ref={printRef}>
                                <div className="w-[210mm] min-h-[297mm] bg-[#fdfdfc] shadow-[0_30px_60px_rgba(0,0,0,0.15),_0_0_0_1px_rgba(0,0,0,0.05)] print:shadow-none print:border-none print:bg-white"
                                    style={{
                                    ...
                                    {/* Inner Paper Padding */}
                                    <div className="p-16 lg:p-24 relative z-10 flex flex-col min-h-[297mm]">
                                        ...
                                        <div className="flex justify-between items-start gap-12 mb-16 relative">
                                            ...
                                            <div className="w-[45%] text-xs tracking-wider space-y-1.5 leading-relaxed relative isolate font-sans">
                                                ...
                                                {/* Fake Hanko Stamp (Visual only) */}
                                                <div className="absolute top-2 right-2 w-14 h-14 border-[-.5px] border-rose-600/40 text-rose-600/40 rounded-full flex items-center justify-center -rotate-12 select-none -z-10 bg-blend-multiply opacity-60 mix-blend-multiply" style={{ borderStyle: 'double', borderWidth: '3px' }}>
                                                    <span className="font-serif text-sm tracking-tighter" style={{ writingMode: 'vertical-rl' }}>事業印</span>
                                                </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-12 font-sans text-[11px] leading-relaxed opacity-80 border-t border-[#2b2927]/20 pt-8 mt-12 relative z-20">
